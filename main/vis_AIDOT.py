...
# ------------------ 路径与参数 ------------------
rgb_dir = Path("/root/autodl-tmp/datasets/AITOD/images/test")      # RGB
#ir_dir  = Path("/root/autodl-tmp/datasets/drone/mydata/image/test")   # IR

method="H2Fhead+gconv+MambaS1234"
method="yolov8s1234"
method="yolo11s1234"
method="yolov12s1234"
model_path = "runs/detect/"+method+"/weights/last.pt"

output_dir = Path("output可视化"+method)
output_dir.mkdir(exist_ok=True)

#selected_stems =["20331","P2173__1.0__1200___1200"]
selected_stems = ["18751"]

selected_stems = ["P2160__1.0__713___600"]

class_names = ["airplane","bridge","storage-tank", "ship", "swimming-pool","vehicle","person","wind-mill"]
line_thickness = 1

#airplane (id=1): 745
#bridge (id=2): 689
#storage-tank (id=3): 5860
#ship (id=4): 17633
#swimming-pool (id=5): 292
#vehicle (id=6): 306665
#person (id=7): 15443
#wind-mill (id=8): 290
...
for i, stem in enumerate(selected_stems, 1):
    ...
    results = model.predict(source=rgb_img, imgsz=640, conf=0.25, iou=0.5, verbose=False)
    r0 = results[0]
